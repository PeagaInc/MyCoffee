...
<html lang="en">
    ...
    <body>
        <div class="limiter">
            <div class="container-login100" style="background-image: url(https://images.pexels.com/photos/114979/pexels-photo-114979.jpeg);">
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    <form action="../ControllerLogin" method="POST" class="login100-form validate-form">
                        <span class="login100-form-title p-b-49">
                            Đăng nhập
                        </span>
                        <c:set var="ans" value="${sessionScope.CTK}"/>
                        <c:if test="${ans == 'sai'}">
                            <p style="text-align: center"><b style="color: red">${"ĐĂNG NHẬP THẤT BẠI!!!"}</b></p>
                        </c:if>
                        <br><br>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Password is required">
                            ...
                            <input class="input100" type="password" name="txtPassword" placeholder="Pasword">
                            <span class="focus-input100" data-symbol="&#xf190;"></span>
                        </div>
