        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Danh Sách Giỏ Hàng Chi Tiết <small></small></h3>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Carts_Detail Table <small></small></h2>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card-box table-responsive">
                                                    <table id="datatable-keytable" class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                session.setAttribute("GIOHANGCT", new ChiTietGioHangDAO().layDanhSach());
                                                            %>
                                                            <c:set var="count" value="0"/>
                                                            <c:set var="ghangct" value="${sessionScope.GIOHANGCT}"/>
                                                            <c:if test="${not empty ghangct}">
                                                                <c:forEach var="rows" items="${ghangct}">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="modal fade" id="${count}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                    <form action="../ControllerGioHangCT" method="POST">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24">Mã giỏ hàng *</label>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <select class="form-control" name="cbxMaGH1" style="width: 540px;">
                                                                                                            <option value="">Chọn giỏ hàng</option>
                                                                                                            <% session.setAttribute("CBXGH", new ChiTietGioHangDAO().cbx_GioHang()); %>
                                                                                                            <c:set var="list" value="${sessionScope.CBXGH}"/>
                                                                                                            <c:if test="${not empty list}">
                                                                                                                <c:set var="magh" value="${rows.getMaGH()}"/>
                                                                                                                <c:forEach var="rows1" items="${list}">
                                                                                                                    <c:set var="tam" value="${rows1.getMaGH()}"/>
                                                                                                                    <c:if test="${tam == magh}">
                                                                                                                        <option selected>${rows1.getMaGH()}</option>
                                                                                                                    </c:if>
                                                                                                                    <c:if test="${tam != magh}">
                                                                                                                        <option>${rows1.getMaGH()}</option>
                                                                                                                    </c:if>
                                                                                                                </c:forEach>
                                                                                                            </c:if>
                                                                                                        </select>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24">Mã sản phẩm *</label>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <select class="form-control" name="cbxMaSP1" style="width: 540px;">
                                                                                                            <option value="">Chọn sản phẩm</option>
                                                                                                            <% session.setAttribute("CBXSP", new ChiTietGioHangDAO().cbx_SanPham());%>
                                                                                                            <c:set var="list" value="${sessionScope.CBXSP}"/>
                                                                                                            <c:if test="${not empty list}">
                                                                                                                <c:set var="masp" value="${rows.getMaSP()}"/>
                                                                                                                <c:forEach var="rows2" items="${list}">
                                                                                                                    <c:if test="${rows2.getMaSP() == masp}">
                                                                                                                        <option selected>${rows2.getMaSP()}</option>
                                                                                                                    </c:if>
                                                                                                                    <c:if test="${rows2.getMaSP() != masp}">
                                                                                                                        <option>${rows2.getMaSP()}</option>
                                                                                                                    </c:if>
                                                                                                                </c:forEach>
                                                                                                            </c:if>
                                                                                                        </select>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24" for="first-name">Số lượng <span class="required">*</span>
                                                                                                    </label><br><br>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <input style="width: 540px;" type="number" id="first-name" name="txtSoLuong1" value="${rows.getSoLuong()}" required="required" class="form-control col-md-7 col-xs-12">
                                                                                                    </div>
                                                                                                </div><br><br>
                                                                                            </div>
                                                                                ...
                                                                                <div style="width: 35%; margin: 200px auto;"  class="modal-dialog modal-dialog-centered" role="document">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body" style="text-align: center; margin-top: 20px;">
                                                                                            ...
                                                                                            <span style="padding-top: 20px; font-size: 20px; color: #454544;">Bạn có chắc chắn muốn xoá giỏ hàng ${rows.getMaGH()}?</span><br>
                                                                                            <form action="../ControllerGioHangCT" method="POST">
                    ...
                    <div class="clearfix"></div>
                    <div cla<div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Pyramid</h2>
                                    <ul class="nav navbar-right panel_toolbox">
