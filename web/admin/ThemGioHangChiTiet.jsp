                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form action="../ControllerGioHangCT" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Mã giỏ hàng *</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="form-control" name="cbxMaGH">
                                                        <option value="">Chọn giỏ hàng</option>
                                                        <% session.setAttribute("CBX", new ChiTietGioHangDAO().cbx_GioHang()); %>
                                                        <c:set var="list" value="${sessionScope.CBX}"/>
                                                        <c:if test="${not empty list}">
                                                            <c:forEach var="rows" items="${list}">
                                                                <option>${rows.getMaGH()}</option>
                                                            </c:forEach>
                                                        </c:if>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="form-control" name="cbxMaSP">
                                                        <option value="">Chọn sản phẩm</option>
                                                        <% session.setAttribute("CBX", new ChiTietGioHangDAO().cbx_SanPham()); %>
                                                        <c:set var="list" value="${sessionScope.CBX}"/>
                                                        <c:if test="${not empty list}">
                                                            <c:forEach var="rows" items="${list}">
                                                                <option>${rows.getMaSP()}</option>
                                                            </c:forEach>
                                                        </c:if>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="number" id="number" min="1" name="txtSoluong" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
