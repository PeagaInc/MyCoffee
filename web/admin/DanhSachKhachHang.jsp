                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Danh Sách Khách Hàng <small></small></h3>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Customers Table <small></small></h2>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card-box table-responsive">
                                                    <table id="datatable-keytable" class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                session.setAttribute("KHACHHANG", new KhachHangDAO().layDanhSach());
                                                            %>
                                                            <c:set var="count" value="0"/>
                                                            <c:set var="khang" value="${sessionScope.KHACHHANG}"/>
                                                            <c:if test="${not empty khang}">
                                                                <c:forEach var="rows" items="${khang}">
                                                                                    ...
                                                                                    <form action="../ControllerKhachHang" method="POST">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header">
                                                                                                <h5 class="modal-title" id="exampleModalCenterTitle">Cập Nhập Khách Hàng</h5>
                                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                    <span aria-hidden="true">&times;</span>
                                                                                                </button>
                                                                                            </div>
                                                                                            <div class="modal-body">
                                                                                                <input type="hidden" name="txtMaKH" value="${rows.getMaKH()}">
                                                                                                <c:set var="txtMaKH" value="${rows.getMaKH()}"/>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24" for="first-name">Họ tên <span class="required">*</span>
                                                                                                    </label><br><br>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <input style="width: 540px;" type="text" id="first-name" name="txtHoTen1" value="${rows.getHoTen()}" required="required" class="form-control col-md-7 col-xs-12">
                                                                                                    </div>
                                                                                                </div><br><br>
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24" for="first-name">Số điện thoại <span class="required">*</span>
                                                                                                    </label><br><br>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <input style="width: 540px;" type="text" id="first-name" name="txtSoDT1" value="${rows.getSoDT()}" required="required" class="form-control col-md-7 col-xs-12">
                                                                                                    </div>
                                                                                                </div><br><br>
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24" for="first-name">Email <span class="required">*</span>
                                                                                                    </label><br><br>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <input style="width: 540px;" type="text" id="first-name" name="txtEmail1" value="${rows.getEmail()}" required="required" class="form-control col-md-7 col-xs-12">
                                                                                                    </div>
                                                                                                </div><br><br>
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24" for="last-name">Địa chỉ <span class="required">*</span>
                                                                                                    </label>
                                                                                                    <div class="col-md-6 col-sm-6 col-xs-12" >
                                                                                                        <textarea style="width: 540px;" rows="5"  id="last-name" name="txtDiaChi1" class="form-control col-md-7 col-xs-12">${rows.getDiaChi()}</textarea>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                ...
                                                                                <div style="width: 35%; margin: 200px auto;"  class="modal-dialog modal-dialog-centered" role="document">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body" style="text-align: center; margin-top: 20px;">
                                                                                            ...
                                                                                            <span style="padding-top: 20px; font-size: 20px; color: #454544;">Bạn muốn xoá khách hàng ${rows.getHoTen()}?</span><br>
                                                                                            <form action="../ControllerKhachHang" method="POST">
