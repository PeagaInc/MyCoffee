                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Danh Sách Thể Loại <small></small></h3>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Categories Table <small></small></h2>
                                                ...
                                                <div class="card-box table-responsive">
                                                    <table id="datatable-keytable" class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:set var="tloai" value="${sessionScope.THELOAI}"/>
                                                            <c:if test="${not empty tloai}">
                                                                <c:forEach var="rows" items="${tloai}">
                                                                    <c:set var="count" value="${count + 1}"/>
                                                                    <tr>
                                                                        <th>${count}</th>
                                                                        <td>${rows.getMaLoai()}</td>
                                                                        <td>${rows.getTenLoai()}</td>
                                                                        <td>
                                                                            ...
                                                                            <div class="modal fade" id="${count}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                    <form action="../ControllerTheLoai" method="POST">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header">
                                                                                                <h5 class="modal-title" id="exampleModalCenterTitle">Cập Nhập Thể Loại</h5>
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24" for="first-name">Mã loại <span class="required">*</span>
                                                                                                    </label><br><br>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <input style="width: 540px;" type="text" id="first-name" name="txtMaLoai1" value="${rows.getMaLoai()}" required="required" class="form-control col-md-7 col-xs-12">
                                                                                                    </div>
                                                                                                </div><br><br>
                                                                                                <div class="form-group">
                                                                                                    <label class="control-label col-md-12 col-sm-12 col-xs-24" for="last-name">Tên loại <span class="required">*</span>
                                                                                                    </label>
                                                                                                    <div class="col-md-12 col-sm-12 col-xs-24">
                                                                                                        <input style="width: 540px;" type="text" id="last-name" name="txtTenLoai1" value="${rows.getTenLoai()}" required="required" class="form-control col-md-7 col-xs-24">
                                                                                                    </div>
                                                                                                </div><br><br>
                                                                                            </div>
                                                                                ...
                                                                                <div style="width: 35%; margin: 200px auto;"  class="modal-dialog modal-dialog-centered" role="document">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-body" style="text-align: center; margin-top: 20px;">
                                                                                            ...
                                                                                            <span style="padding-top: 20px; font-size: 20px; color: #454544;">Bạn có chắc chắn muốn xoá thể loại ${rows.getTenLoai()}</span><br>
                                                                                            <form action="../ControllerTheLoai" method="POST">
                                                                                                ...
                                                                                                <input type="hidden" name="txtMaLoai" value="${rows.getMaLoai()}">
                                                                                                <input type="hidden" name="txtTenLoai" value="${rows.getTenLoai()}">
                                                                                            </form>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
